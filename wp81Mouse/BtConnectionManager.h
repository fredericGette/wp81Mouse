...
/* Compiler settings for btconnectionmanager.idl:
...
extern "C" {
	...
	// WP81: Commented the following lines.
	//#else
...
#define __IBtRadioController_INTERFACE_DEFINED__
	...
	public:
		...
		virtual HRESULT STDMETHODCALLTYPE CreateScoAudioDevice(
			/* [in] */ BTH_ADDR btAddr,
			/* [in] */ BOOLEAN fSupportVolumeControl,
			/* [in] */ BOOLEAN fHeadset,
...
#define IBtRadioController_CreateScoAudioDevice(This,btAddr,fSupportVolumeControl,fHeadset,pCallback,ppConnection)	\
    ( (This)->lpVtbl -> CreateScoAudioDevice(This,btAddr,fSupportVolumeControl,fHeadset,pCallback,ppConnection) ) 
